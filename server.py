...
def _105(_106):
    ...
    if any(w in _107 for w in ["опасность по бпла","угроза атаки","внимание по бпла","меры безопасности","опасность сохраняется","повторно","fpv","fpv-дронам","единичных бпла","внимание"]): return "drone_danger"
    return None
