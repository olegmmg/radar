...
def extract_regions(text):
    ...
    # 👇 КЛЮЧЕВОЕ: проверяем, не является ли упоминание районом
    # Если в тексте есть "XXX район" или "XXX районе" - это НЕ регион
    ...
    for alias, norm in REGION_ALIASES.items():
        ...
        # Ищем фразы типа "Кировский район", "Кировском районе" и т.д.
        ...
        # Также проверяем короткие названия (Киров, Тула и т.д.)
    ...
    # Поиск областей в родительном падеже (например: "Кировской области")
